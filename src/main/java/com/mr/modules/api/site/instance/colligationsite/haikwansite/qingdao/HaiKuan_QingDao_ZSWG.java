 ...
 * @DateTime 2018-08-05
 * 主题：青岛海关走私违规行政处罚
 * url:http://qingdao.customs.gov.cn/qingdao_customs/406484/406544/406553/406555/index.html
 * 属性：企业名称, 执行文号, 处罚事由, 处罚依据, 处罚结果, 认定机关, 发布日期
 */
@Slf4j
@Scope("prototype")
@Component("haikuan_qingdao_zswg")
public class HaiKuan_QingDao_ZSWG extends SiteTaskExtend_CollgationSite_HaiKWan {
    @Autowired
    ...
    protected String execute() throws Throwable {
        String ip = "";
        String port = "";
        String source = "青岛海关走私违规行政处罚";
        String area = "qingdao";//区域为：青岛
        String baseUrl = "http://qingdao.customs.gov.cn";
        String url = "http://qingdao.customs.gov.cn/qingdao_customs/406484/406544/406553/406555/index.html";
    ...
    public void extractWebData(Map<String,String> map){
        ...
        adminPunish.setSubject("青岛海关走私违规行政处罚");
        adminPunish.setSource("青岛海关");
        ...
        adminPunish.setJudgeAuth("中华人民共和国青岛海关");
        for(String str : textArr){
            ...
            if(adminPunish.getJudgeNo().equals("")&&str.contains("发布主题")&&str.contains("处罚决定")){
                adminPunish.setJudgeNo(str.replaceAll(".*处罚决定",""));
            }
