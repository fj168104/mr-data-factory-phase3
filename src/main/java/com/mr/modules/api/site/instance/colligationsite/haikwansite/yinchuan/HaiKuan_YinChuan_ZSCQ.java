...
public class HaiKuan_YinChuan_ZSCQ extends SiteTaskExtend_CollgationSite_HaiKWan {
    ...
    private void parseText(Map<String, String> map, String content) {
        ...
        adminPunish.setSource("银川海关");// 数据来源
        ...
        for (String lineText : content.split("\n")) {//按行分割读取
            //处罚决定书文号
            if (StrUtil.isEmpty(adminPunish.getJudgeNo()) && (lineText.contains("罚字") || lineText.contains("银关") || lineText.contains("违字") || lineText.contains("知字") || lineText.contains("关缉") || lineText.contains("单字")) && !lineText.contains("根据")) {
