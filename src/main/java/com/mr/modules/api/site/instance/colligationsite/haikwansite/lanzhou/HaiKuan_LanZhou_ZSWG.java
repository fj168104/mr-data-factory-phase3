...
public class HaiKuan_LanZhou_ZSWG extends SiteTaskExtend_CollgationSite_HaiKWan {
    ...
    private void parseText(Map<String, String> map, String content) {
        ...
        adminPunish.setSource("兰州海关");// 数据来源
        ...
        for (String lineText : content.split("\n")) {//按行分割读取
            //处罚决定书文号
            if (StrUtil.isEmpty(adminPunish.getJudgeNo()) && (lineText.contains("罚字") || lineText.contains("兰关") || lineText.contains("违字") || lineText.contains("知字") || lineText.contains("关缉") || lineText.contains("单字")) && !lineText.contains("根据")) {
