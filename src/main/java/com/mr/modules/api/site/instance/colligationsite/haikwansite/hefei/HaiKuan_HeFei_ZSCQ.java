 ...
 * @DateTime 2018-08-05
 * 主题：合肥海关知识产权行政处罚
 * url:http://hefei.customs.gov.cn/hefei_customs/479578/479612/479614/479615/index.html
 * 属性：企业名称, 执行文号, 处罚事由, 处罚依据, 处罚结果, 认定机关, 发布日期
 */
@Slf4j
@Scope("prototype")
@Component("haikuan_hefei_zscq")
public class HaiKuan_HeFei_ZSCQ extends SiteTaskExtend_CollgationSite_HaiKWan {
    @Autowired
    ...
    protected String execute() throws Throwable {
        String ip = "";
        String port = "";
        String source = "合肥海关知识产权行政处罚";
        String area = "hefei";//区域为：合肥
        String baseUrl = "http://hefei.customs.gov.cn";
        String url = "http://hefei.customs.gov.cn/hefei_customs/479578/479612/479614/479615/index.html";
    ...
    public void extractWebData(Map<String,String> map){
        ...
        adminPunish.setSubject("合肥海关知识产权行政处罚");
        ...
        for(String str : textArr){
            if(str.contains("：")){
                ...
                if(adminPunish.getJudgeNo().equals("")&&str.contains("发布主题")&&str.contains("政处罚决定书")&&str.contains("知字")){
