...
public class HaiKuan_JiangMen_XZCF extends SiteTaskExtend_CollgationSite_HaiKWan {
    ...
    public void extractWebData(Map<String,String> map){
        ...
        adminPunish.setSubject("江门海关行政处罚");
        adminPunish.setSource("江门海关");
        ...
        text = text.replaceAll("行政处罚决定书[\\s]{1,}","行政处罚决定书");
        ...
        adminPunish.setJudgeAuth("中华人民共和国江门海关");
        for(String str : textArr){
            if(str.contains("：")){
                ...
                if(adminPunish.getJudgeNo().equals("")&&str.contains("发布主题")&&str.contains("行政处罚决定书")&&str.contains("号")){
