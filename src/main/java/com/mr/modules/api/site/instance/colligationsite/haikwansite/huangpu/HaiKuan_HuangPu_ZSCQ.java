...
public class HaiKuan_HuangPu_ZSCQ extends SiteTaskExtend_CollgationSite_HaiKWan {
    ...
    private void parseText(Map<String, String> map, String content) {
        ...
        for (String lineText : content.split("\n")) {//按行分割读取
            //处罚决定书文号
            if (StrUtil.isEmpty(adminPunish.getJudgeNo()) && ((lineText.contains("知字")) || lineText.contains("关知") | lineText.contains("关法")) && !lineText.contains("决定书") && !lineText.contains("根据")) {
