 ...
 * @DateTime 2018-08-05
 * 主题：宁波海关走私违规行政处罚
 * url:http://ningbo.customs.gov.cn/ningbo_customs/470752/470779/470781/470783/index.html
 * 属性：企业名称, 执行文号, 处罚事由, 处罚依据, 处罚结果, 认定机关, 发布日期
 */
@Slf4j
@Scope("prototype")
@Component("haikuan_ningbo_zswg")
public class HaiKuan_NingBo_ZSWG extends SiteTaskExtend_CollgationSite_HaiKWan {
    @Autowired
    ...
    protected String execute() throws Throwable {
        String ip = "";
        String port = "";
        String source = "宁波海关走私违规行政处罚";
        String area = "ningbo";//区域为：宁波
        String baseUrl = "http://ningbo.customs.gov.cn";
        String url = "http://ningbo.customs.gov.cn/ningbo_customs/470752/470779/470781/470783/index.html";
    ...
    public void extractWebData(Map<String,String> map){
        ...
        adminPunish.setSubject("宁波海关走私违规行政处罚");
